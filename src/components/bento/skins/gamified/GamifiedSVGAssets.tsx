...
const FRAME_PADDING = 16; // GamifiedBoard's frame also has p-3 md:p-4 BEFORE the cork div starts — the visible brown band is border + padding, not the border alone; using the md:p-4 (16px) value as the representative size. MUST match GamifiedBoard's frame padding exactly (broke twice already from these drifting apart) — if that padding ever changes, update this in lockstep.
