...
export const AppIcon = ({ src, alt, className = '', ...props }: AppIconProps) => {
  ...
  return (
    <div className={`flex-shrink-0 w-[90px] h-[90px] md:w-[102px] md:h-[102px] rounded-[28px] md:rounded-[32px] shadow-[0_var(--ui-depth)_0_0_var(--shadow-color)] overflow-hidden flex items-center justify-center ${isEmpty ? 'bg-surface-base border-[length:var(--border-width-sm)] border-dashed border-ink-base/20' : 'bg-surface-base'} ${className}`}>
      {isEmpty
