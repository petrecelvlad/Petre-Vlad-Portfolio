...
export const AppIcon = ({ src, alt, className = '', ...props }: AppIconProps) => {
  ...
  return (
    <div className={`flex-shrink-0 w-[90px] h-[90px] md:w-[102px] md:h-[102px] rounded-[28px] md:rounded-[32px] shadow-[0_10px_0_0_var(--color-ink-base)] overflow-hidden flex items-center justify-center ${isEmpty ? 'bg-surface-base border-2 border-dashed border-ink-base/20' : 'bg-surface-base'} ${className}`}>
      {isEmpty
