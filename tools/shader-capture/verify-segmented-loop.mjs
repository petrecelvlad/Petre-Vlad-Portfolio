...
const BASE = 'http://localhost:4175/Petre-Vlad-Portfolio/';
...
async function main() {
  ...
  await page.screenshot({ path: 'tools/shader-capture/out/segmented-loop-t0.png', timeout: 10000 }).catch((e) => console.log('(screenshot skipped)', e.message.split('\n')[0]));
  await page.waitForTimeout(3000);
  await page.screenshot({ path: 'tools/shader-capture/out/segmented-loop-t3.png', timeout: 10000 }).catch((e) => console.log('(screenshot skipped)', e.message.split('\n')[0]));
